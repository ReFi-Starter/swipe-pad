...
contract BoostManager is Ownable {
    ...
    /**
     * @dev Updates the verification status of a user.
     * @param userAddress The address of the user.
     * @param _isVerified The new verification status.
     */
    function updateVerificationStatus(address userAddress, bool _isVerified) external onlyOwner {
        isVerified[userAddress] = _isVerified;
        emit VerificationStatusUpdated(userAddress, _isVerified);
    }
